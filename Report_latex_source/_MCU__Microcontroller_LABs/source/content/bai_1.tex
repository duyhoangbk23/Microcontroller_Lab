...
\begin{figure}[H]
    \centering
    \includegraphics[width=5in]{source/picture/bai_1/Proteus_sche_ex1.PNG}
    \caption{\parbox{8cm}{\text{ https://github.com/duyhoangbk23/Microcontroller_Lab/blob//Proteus_EX1/EX1.pdsprj}}
}
\end{figure}
...
\begin{lstlisting}[Source code for exercise 1]
  while (1)
  {
    /* USER CODE END WHILE */
...
\textbf{Report 1: } Present the schematic.
%present the schematic from image EX3_4_sche.PNG
\begin{figure}[H]
    \centering
